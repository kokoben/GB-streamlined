...
export const BOMBCAST_SEARCH_FETCH = 'BOMBCAST_SEARCH_FETCH';
export const BOMBCAST_SEARCH_FETCH_SUCCESS = 'BOMBCAST_SEARCH_FETCH_SUCCEEDED';
export const BOMBCAST_SEARCH_FETCH_FAIL = 'BOMBCAST_SEARCH_FETCH_FAILED';
